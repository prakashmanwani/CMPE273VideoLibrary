...
public class ServiceServiceLocator extends org.apache.axis.client.Service implements services.ServiceService {
    ...
    private java.lang.String Service_address = "http://localhost:8080/CMPE273VideoLibrary/services/Service";
    ...
    public services.Service getService() throws javax.xml.rpc.ServiceException {
    ...
    public services.Service getService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            services.ServiceSoapBindingStub _stub = new services.ServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (services.Service.class.isAssignableFrom(serviceEndpointInterface)) {
                services.ServiceSoapBindingStub _stub = new services.ServiceSoapBindingStub(new java.net.URL(Service_address), this);
                _stub.setPortName(getServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://services", "ServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://services", "Service"));
        }
